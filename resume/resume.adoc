...
I'm a Software Engineer who found his way into the world of DevOps
and enjoying every minute of it!

I share my knowledge on sound Software Engineering practices with my Ops
coworkers and what I know about operations with my Dev coworkers. I also
employ my management education to give my team's mission more context. I
enjoy what I do, not only because I get to tackle the unknown and level up
everyday, but also because I get to share the magic with my colleagues at
all levels.
...
- Automated deployments of customer-facing services.

- Implemented a CI/CD pipeline for microservice-based applications.

- Integrated the above-mentioned CI/CD pipeline with Kubernetes.

- Created a reusable toolkit for automatically setting up the above-mentioned
  CI/CD pipeline so that other departments can use it.
