== Mark Maglana
=== DevOps Engineer; Educated in Software Engineering and Management
...
I'm a DevOps Engineer with a Software Engineering and Management background.
...
*Senior Staff, DevOps* (Dec 2017 - present) +
Tesla, Fremont, CA
