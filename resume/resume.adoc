...
// Deliberately unlinked. The post that fronted this talk is drafted, and
// the bare slide deck at /swampup2017 is not what the entry claims.
Baking and Frying Machine Images (jFrog SwampUP Napa Valley 2017), 
...
*Senior Systems and Software Engineer*  (Aug 2021 - present) +
