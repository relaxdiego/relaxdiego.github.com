...
Developer productivity is my vocation. CI/CD is my approach and management
knowledge is the rudder that keeps my actions pointed in the right direction.
...
build and publish, (2) static code analysis, (3) notifications, (4) build health
dashboards, and (5) auto-deployment to Docker hosts or to Kubernetes.
