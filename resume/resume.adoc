...
My guiding principle in my professional journey is summed up by this
question: "How can I take this experience and make myself better at
delivering software systems that users will love?"
...
no matter what, there's always something new to learn and solve everyday.

== Certifications

CNCF Certified Kubernetes Administrator +
Certificate ID: CKA-1700-0020-0100 +
(Expired Sep 2020 - Will renew some other time)
...
Amplify Inc specialized in the design and delivery of building auxiliary
systems such as Fire Detection and Alarm Systems; Local Area Networking;
Wireless Design and Implemention; as well as Building Management Systems.
