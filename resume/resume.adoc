...
Developer productivity is my vocation. CI/CD plus DevOps is the way
that I am approaching it and business management knowledge is the rudder
that points my actions in the right direction.
...
Implemented a CI/CD platform that software engineers used for their applications.
They onboarded their projects via a declarative YAML file and Dockerfiles.
The platform provided services such as (1) container image build and publish,
(2) static code analysis, (3) notifications, (4) build health dashboards, and
(5) auto-deployment to Docker hosts or to Kubernetes.
