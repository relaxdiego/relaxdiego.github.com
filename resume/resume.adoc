...
such as How I Built My Own BDD Framework (Ruby on Rails Meetup, Los Angeles), 
Using Vagrant to Install OpenStack Tempest (OpenStack Summit Atlanta 2015), and 
How to Write Fully-Tested Ansible Modules (AnsibleFest NY 2016).
