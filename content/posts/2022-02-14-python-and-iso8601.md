...
*NOTE: All code snippets below are available on [Github](https://github.com/relaxdiego/relaxdiego.github.com/tree/master/snippets/iso8601)*.
...
{{< snippet file="iso8601/s02_check_time_zone.py" lang="python" linenos="true" >}}
...
{{< snippet file="iso8601/s03_include_time_zone_in_str.py" lang="python" linenos="true" >}}

That works \- but only on Python 3.11 and newer.

When this post was first written, that same snippet raised
`ValueError: Invalid isoformat string: '1979-01-01T00:00:00Z'`, and the
method's documentation explained why:
...
Python 3.11 [widened `fromisoformat()` to accept most ISO 8601 strings](https://docs.python.org/3/whatsnew/3.11.html#datetime),
the trailing 'Z' included, and dropped that caution from the docs.

So if you are on 3.11 or newer, you can skip the next snippet. But if you
still have to support 3.10 or older, and don't have the luxury of
installing a third-party library, you could just translate the 'Z'
character...

{{< snippet file="iso8601/s04_translate_z_suffix.py" lang="python" linenos="true" >}}
...
{{< snippet file="iso8601/s05_auto_add_time_zone.py" lang="python" linenos="true" >}}
...
{{< snippet file="iso8601/s06_there_is_only_zulu.py" lang="python" linenos="true" >}}

Great! But wait one more thing: can we manually override the time zone?

{{< snippet file="iso8601/s07_there_is_also_other_zones.py" lang="python" linenos="true" >}}
